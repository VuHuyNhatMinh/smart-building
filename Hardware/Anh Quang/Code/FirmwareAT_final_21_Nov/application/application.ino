...
Timer timer1;       /* Timer of DS3231 RTC, TSL2561 Lux Sensor, RGB Color Sensor */
Timer timer2;       /* Timer of SHT31 temper and humid, CO2 Mh Z19 Sensor, eCO2 and TVOC CSS811 Sensor, GP2y1010AuF Dust Sensor  */
Timer timer3;       /* Timer of Sound MAX9814 Sensor */
Timer timer4;       /* Timer for Task Transmission Data to Module Wifi via UART Protocol */
/*******************************************************************************
   Definitions
 ******************************************************************************/
...
boolean pinStatus = LOW;      /* Assign status of pin is Low */
...
void setup() {
  ...
  timer3.setInterval(200);  /* Sample time of Sound MAX9814 Sensor */
  timer4.setInterval(60000);  /* Sample timer of Data Transmission UART */
  /* Set our callback function */
  timer1.setCallback(GetGroupDateTimeLuxRGBValue);
  timer2.setCallback(GetGroupTemperHumidCo2TvocDustValue);
  timer3.setCallback(GetNoiseEventsValue);
  timer4.setCallback(TransmissionAllData);
...
/*
    ...
    @return None
*/
void NumberOfPeople() /* ISR for conting Motions */
{
  g_countPeople++;
}
/*
    @brief The function takes the value of date, time, day, illuminance, Red Green Blue Value
    @return None
*/
void GetGroupDateTimeLuxRGBValue(void)
{
  /* Get DateTime */
...
/*
    @brief function to get Temperature, Humidity, CO2, eCO2, TVOC, Dust Density Value in air
    @return None
*/
void GetGroupTemperHumidCo2TvocDustValue(void)
{
...
void DateTimeDisplay(void)
{
  ...
  display.print("PeopleInRoom: ");
  display.print(g_countPeople);
  display.display();
}
/*
...
void TransmissionAllData(void)
{
  ...
  root["illuminance"] = g_Lux;                /* 16 digital Output about 1 - 40k lux, The unit of light intensity is lux */
  root["red"] = g_Red;
  root["green"] = g_Green;
  root["blue"] = g_Blue;
  ...
  root["eco2"]  = g_eCO2;               /* 400 -> 29206ppm datattsheet*/
  root["tvoc"] = g_TVOC;                /* 0 -> 32768ppb  parts per billion datasheet*/
  root["pm25"] = g_dustDensity;         /* 0 -> 5V,dust 0 - > 0.8 mg/m3 datasheet, unit mg/m3*/
