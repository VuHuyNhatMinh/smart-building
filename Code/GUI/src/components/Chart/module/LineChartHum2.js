...
function LineChartHum1({data}) {
  ...
  useEffect(() => {
    console.count("this is HUMIDITY 4C:75:25:06:A1:E7!!!!")
    let today = new Date();
    console.count(today)
    console.count("This is today from HUMIDIITY 4C:75:25:06:A1:E7")
